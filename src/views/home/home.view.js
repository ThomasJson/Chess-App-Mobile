export class HomeView {
    ...
    importCss = async () => {
        const cssModule = await import("./home.view.css", {
            assert: { type: "css" },
        });
    ...
    render = () => {
        ...
        return `
            <header class="row background-color color2">
                <div id="logo"><img class="logo" src="./src/img/bt-logo2.png"></div>
                <div id="titre">BLUNDER THINGS</div>

                <div id="login-bloc" class="row">

                    <div id="sign-up" class="buttonEffect">
                        <i class="fa-solid fa-arrow-right-to-bracket"></i>
                    </div>

                    <div id="sign-in" class="buttonEffect">
            ...
            <main class="col">
                ...
                <div id="adversaire-container" class="row">
                    <div id="adversaire" class="player row">
                        <p class="row align-center">Adversaire</p>
                        <div class="clock">- - : - -</div>
                    </div>
                </div>
                ...
                <div id="user-container" class="row">
                    <div id="user" class="player row">
                        <p class="row align-center">User</p>
                        <div class="clock">- - : - -</div>
                    </div>
                </div>
                
                <div id="newGame-bloc">
                    <div id="newGame-link" class="buttonEffect"><a class="spa-link" href="/settings">Nouvelle Partie</a></div>
                </div>
            </main>
